...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Delete Employee from Project Screen <h1></div>
			<br/>
			<%
			...
			<th><font size="3" color="black">Manager ID</th>
			...
			<th><font size="3" color="black">Assigned Date</th>
			<th><font size="3" color="black">Delete Employee</th></tr>
<%
String user = session.getAttribute("user").toString();
	Connection con = DBCon.getCon();
	Statement stmt = con.createStatement();
	ResultSet rs = stmt.executeQuery("select * from assignemployee where assign_to='"+user+"'");
	while(rs.next()){%>
	...
	<td><font size="3" color="black"><%=rs.getString(2)+" - "+DBCon.getName(rs.getString(2))%></font></td>
	 ...
	 <td><a href="DeleteEmployee?t1=<%=rs.getString(1)%>&t2=<%=rs.getString(2)%>"><font size="3" color="black">Click Here</a></td></tr>
	</tr>
	 <%}%>
</table>
</form>
