...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="f1" method="post" action="AddEmptoProject" onsubmit="return checkField(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Add Employee to Project Screen <h1></div>
			<br/>
			<%
...
<%
	...
	rs = stmt.executeQuery("select Employee_ID,Employee_name,usertype from employees where Employee_ID='"+session.getAttribute("user").toString()+"'");
	while(rs.next()){%>
