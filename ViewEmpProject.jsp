...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			View Employee Assigned Project Screen <h1></div>
			<br/>
			<%
			...
			<th><font size="3" color="black">HR ID</th>
...
String user = session.getAttribute("user").toString();
	...
	ResultSet rs = stmt.executeQuery("select * from assignemployee where employee_id='"+user+"'");
	while(rs.next()){%>
