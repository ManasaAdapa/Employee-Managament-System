...
function checkField(page) {
	...
	if(page.t4.value.length==0) {
		alert("Reason of leave must be entered");
		page.t4.focus();
		return false;
	}	
	return true;
...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="f1" method="post" action="ApplyLeave" onsubmit="return checkField(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Leave Application Screen <h1></div>
			<br/>
			<%
...
<tr><td><font size="3" color="black">Reason&nbsp;Of&nbsp;Leave</td><td><input type="text" name="t4" size="40" /></td></tr>
