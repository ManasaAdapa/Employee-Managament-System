...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<th><font size="3" color="black">From Date</th>
			<th><font size="3" color="black">To Date</th>
			<th><font size="3" color="black">Leave Reason</th>
			<th><font size="3" color="black">Applied Date</th>
			<th><font size="3" color="black">Approve Leave</th></tr>
<%
String user = session.getAttribute("user").toString();
	Connection con = DBCon.getCon();
	Statement stmt = con.createStatement();
	ResultSet rs = stmt.executeQuery("select * from leaveapplication where status='Pending'");
	while(rs.next()){%>
	...
	<td><font size="3" color="black"><%=rs.getString(2)%></font></td>
	 ...
	 <td><font size="3" color="black"><%=rs.getString(5)%></font></td>
	  <td><a href="ApproveLeaves?t1=<%=rs.getString(1)%>&t2=<%=rs.getString(4)%>"><font size="3" color="black">Click Here</a></td></tr>
	</tr>
	 <%}%>
</table>
</form>
